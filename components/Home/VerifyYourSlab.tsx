          ...
          >
            ...
            <div className="mt-5 lg:mt-6 flex w-full flex-row">
              <input
                ...
                className="h-[50px] lg:h-[61px] w-full rounded-l-[10px] lg:rounded-l-[13px] border-[2px] border-[#00D0FF] bg-[#242424] px-4 text-white placeholder:text-white/40 outline-none focus:ring-1 focus:ring-[#00D0FF] transition-all"
                style={{
