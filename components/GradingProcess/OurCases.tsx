    ...
    <section className="w-full flex bg-black justify-center font-poppins antialiased overflow-hidden">
      <div className="w-full flex flex-col items-center max-w-[1200px] gap-[20px] lg:gap-[40px] px-4 py-10">
        ...
        <motion.div
          ...
          className="w-full flex items-center justify-center lg:h-[90px]"
        >
        ...
        <div className="w-full flex flex-col items-center border-white/10 max-w-[1200px] gap-[30px] rounded-[12px] border p-6 sm:p-10 lg:pt-[45px] lg:pr-[70px] lg:pb-[45px] lg:pl-[70px] bg-gradient-to-b from-white/[0.084] to-zinc-400/[0.042]">
          <div className="flex flex-col items-center justify-start max-w-[1124px] w-full gap-[60px] lg:gap-[50px]">
            ...
            <motion.div
              ...
              className="flex flex-col lg:flex-row items-center lg:items-center justify-between w-full max-w-[1078px] gap-8 lg:gap-0"
            >
              {/* IMAGE CONTAINER */}
              <motion.div
                variants={imageVariants}
                className="relative w-[280px] h-[480px] sm:w-[320px] sm:h-[548px] lg:w-[354px] lg:h-[606px] rounded-[6px] overflow-hidden flex-shrink-0"
              >
                <Image
                  src="/SlabDisplay.png"
              ...
              <motion.div
                ...
                className="flex flex-col justify-center w-full lg:w-[602.47px] gap-[20px]"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={containerVariants}
              className="flex flex-col-reverse lg:flex-row items-center lg:items-center justify-between w-full max-w-[1078px] gap-8 lg:gap-0"
            >
              {/* Alpha: Text Side */}
              <motion.div
                variants={imageVariants}
            ...
            <motion.div
              ...
              className="w-full lg:w-[1124px] lg:min-h-[132px] mt-4"
            >
